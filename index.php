...
<html>
						...
						<div class="display-tc js-fullheight animate-box" data-animate-effect="fadeIn">
							...
							<p>
								<ul class="fh5co-social-icons">
									<li><a href="https://www.facebook.com/mouhebmhh"><i class="icon-facebook2"></i></a></li>
									<li><a href="https://www.linkedin.com/in/mouhebmhamdi/"><i class="icon-linkedin2"></i></a></li>
			...
			<div class="row p-l-50">
				<div class="col-md-5 ">
					<ul class="info">
						...
						<li><span class="first-block">Email:</span><span class="second-block">infos@mouheb.com	</span></li>
						<li><span class="first-block">Website:</span><a class="second-block" href="http://www.mouheb.com">www.mouheb.com</a></li>
						<li class="p-l-100"><span class="first-block">Address:</span><span class="second-block">3130 Monji Slim 94th Street, Kairouan Tunisia   </span></li>
					</ul>
				</div>
				<div class="col-md-7">
					
					<p>
						 I am a JAVA full stack developer, I master a different languages and frameworks among which spring boot,
						 hibernate, JAVA, android,Java swing, SQL,noSQL,plSQL in addition, I excelled in the field of graphic 
						 design (photoshop, illustrator).<br> 
					
						 What characterizes me is creativity, I put all my skills in the field of development.<br> 
					
						This creativity, coupled with a great autonomy, will allow me to excel tomorrow in several positions. 
					</p>
					<p>
						<ul class="fh5co-social-icons">
							
							<li><a href="https://www.facebook.com/mouhebmhh"><i class="icon-facebook3"></i></a></li>
							<li><a href="https://www.linkedin.com/in/mouhebmhamdi/"><i class="icon-linkedin2"></i></a></li>
							<li><a href="http://www.mouheb.com"><i class="icon-dribbble2"></i></a></li>
						</ul>
					</p>
	...
	<div id="resume" class="fh5co-bg-color">
		<div class="container">
						...
						<li class="timeline-inverted animate-box">
							...
							<div class="timeline-panel">
								<div class="timeline-heading">
									...
									<span class="company">higher institute of computer science mahdia - <br> 2020 - Now</span>
								</div>
								<div class="timeline-body">
									<p>Data scientiste student </p>
								</div>
							</div>
						</li>
						<li class="animate-box timeline-unverted">
							...
							<div class="timeline-panel">
								<div class="timeline-heading">
									...
									<span class="company">higher institute of computer science mahdia - <br> - 2018 - 2020</span>
								</div>
								<div class="timeline-body">
									<p>Basic Bachelor in Computer Science </p>
								</div>
							</div>
						</li>
						<li class="timeline-inverted animate-box">
							...
							<div class="timeline-panel">
								<div class="timeline-heading">
									...
									<span class="company">secondary school of Kairouan<br> - 2017 - 2018</span>
								</div>
								<div class="timeline-body">
									<p>Bachelorettes of computer science </p>
								</div>
							</div>
						</li>
		...
		<div id="skills" class="container">
			...
			<div class="row row-pb-md">
				<div class="col-md-3 col-sm-6 col-xs-12 text-center">
					<div class="chart" data-percent="97"><span><strong>HTML5</strong>97%</span></div>
				</div>
				<div class="col-md-3 col-sm-6 col-xs-12 text-center">
					<div class="chart" data-percent="93"><span><strong>Bootstrap</strong>93%</span></div>
				</div>
				<div class="col-md-3 col-sm-6 col-xs-12 text-center">
				...
				<div class="col-md-3 col-sm-6 col-xs-12 text-center">
					<div class="chart" data-percent="65"><span><strong>Hadoop</strong>65%</span></div>
				</div>
				<div class="col-md-3 col-sm-6 col-xs-12 text-center">
					<div class="chart" data-percent="75"><span><strong>NoSQL</strong>75%</span></div>
				</div>
				<div class="col-md-3 col-sm-6 col-xs-12 text-center">
					<div class="chart" data-percent="85"><span><strong>Spring Boot</strong>85%</span></div>
				</div>
				<div class="col-md-3 col-sm-6 col-xs-12 text-center">
					<div class="chart" data-percent="75"><span><strong>Hibernate</strong>75%</span></div>
				</div>
				<div class="col-md-3 col-sm-6 col-xs-12 text-center">
					<div class="chart" data-percent="85"><span><strong>Thymleaf</strong>85%</span></div>
				</div>
				<div class="col-md-3 col-sm-6 col-xs-12 text-center">
					<div class="chart" data-percent="85"><span><strong>JAVA</strong>90%</span></div>
				</div>
				<div class="col-md-3 col-sm-6 col-xs-12 text-center">
					<div class="chart" data-percent="90"><span><strong>J2EE</strong>90%</span></div>
				</div>
				<div class="col-md-3 col-sm-6 col-xs-12 text-center">
					<div class="chart" data-percent="35"><span><strong>Angular</strong>35%</span></div>
				</div>
				<div class="col-md-3 col-sm-6 col-xs-12 text-center">
					<div   class="chart" data-percent="70"><span><strong>Programmation SAS</strong>70%</span></div>
				</div>
